...
export const TalentSearchSection = (): JSX.Element => {
  ...
  const reasons = [
    {
      number: "01",
      title: "Top 1% global professionals, pre-vetted.",
      label: "QUALITY",
    },
  ];
      ...
      <div className="mx-auto flex w-full max-w-[1440px] flex-col px-6 py-[70px] md:px-10 lg:px-[140px]">
        ...
        <div className="mt-[74px]">
          {reasons.map((reason) => (
            <Card
              key={reason.number}
              className="rounded-none border-0 border-b border-solid border-[#14101f14] bg-white shadow-none"
            >
