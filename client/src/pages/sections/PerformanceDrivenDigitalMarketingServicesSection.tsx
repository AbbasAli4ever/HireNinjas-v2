...
const serviceCards = [
  {
    ...
    description: [
      "Performance media built around clean attribution",
      "and incremental lift, not vanity clicks.",
    ],
  },
  {
    number: "02",
  ...
  },
  {
    ...
    description: [
      "Editorial calendars and creator partnerships that",
      "move beyond posts into pipeline.",
    ],
  },
  {
    number: "04",
    ...
    description: [
      "Narrative, messaging and assets that turn",
      "category complexity into a clear story.",
    ],
  },
  {
    number: "05",
    ...
    description: [
      "Funnel diagnostics, experimentation and landing",
      "systems wired for measurable lift.",
    ],
  },
  {
    number: "06",
    ...
    description: [
      "Senior operators embedded into your team ,",
      "strategy, ops or hands-on execution.",
    ],
  },
];
          ...
          <header className="flex w-full flex-col gap-8 lg:flex-row lg:items-end lg:gap-[50px]">
            ...
            <div className="flex max-w-[681.33px] flex-1 flex-col items-start pt-0 lg:pt-[17.39px]">
              <p className="[font-family:'Inter',Helvetica] text-lg font-normal leading-[27.9px] text-[#3a3445]">
                HireNinjas provides UAE companies with modern performance
                marketing strategies to increase visibility, generate leads and
                expand revenue through modern performance marketing approaches.
              </p>
            </div>
          </header>
