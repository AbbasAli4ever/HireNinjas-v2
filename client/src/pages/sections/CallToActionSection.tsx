...
export const CallToActionSection = (): JSX.Element => {
  return (
    <section className="relative w-full bg-white">
      <div className="mx-auto w-full max-w-[1440px] px-4 py-10 sm:px-6 md:px-10 lg:px-[140px] lg:py-[70px]">
          ...
          <CardContent className="rounded-[28px] bg-[#4a0d8c] px-6 py-10 sm:px-10 md:px-16 lg:px-40 lg:py-[50px]">
            <div className="flex flex-col items-center justify-center gap-[21.3px] text-center">
              ...
              <p className="max-w-[820px] [font-family:'Inter',Helvetica] text-[15px] font-normal leading-[26.4px] tracking-[0] text-[#f5efe6c7] sm:text-[16px] lg:text-[17px]">
                With HireNinjas, you can strengthen teams and create smarter
                marketing systems,
                <br />
                this way everyone wins.
                <br />
                <br />
                No matter the situation, whether you are hiring talent or
                expanding brand recognition
                <br />
                in Dubai and Abu Dhabi, our services help you move faster with
                confidence.
              </p>
              <nav
              ...
              >
                <Button
                  type="button"
                  className="h-auto rounded-[999px] bg-white pl-[22px] pr-2 py-1.5 text-[#14101f] hover:bg-white/95"
                >
                ...
                <Button
                  type="button"
                  variant="ghost"
                  className="h-auto rounded-[999px] border border-solid border-[#f5efe629] bg-transparent px-[22px] py-3.5 [font-family:'Inter',Helvetica] text-[14.5px] font-medium leading-[normal] tracking-[0] text-[#f5efe6] hover:bg-white/5 hover:text-[#f5efe6]"
                >
                  See case studies
                </Button>
              </nav>
        ...
        <div className="mx-auto w-full max-w-[1440px] px-4 pb-9 pt-16 sm:px-6 md:px-10 lg:px-[120px]">
          <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-10 px-0 lg:px-10">
            <div className="grid gap-10 md:grid-cols-2 lg:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)_minmax(0,1fr)_minmax(0,1fr)]">
              ...
              <nav
                aria-label="Services"
                className="flex h-fit flex-col items-start gap-4"
              >
                <h3 className="[font-family:'Satoshi-Bold',Helvetica] text-[13px] font-bold leading-[20.8px] tracking-[1.30px] text-[#0f0a1f]">
                  SERVICES
                </h3>
                <ul className="flex w-full flex-col items-start gap-2.5">
                  {services.map((item) => (
                    <li key={item} className="w-full">
                      <button
                        type="button"
                        className="flex w-full items-start text-left [font-family:'Montserrat',Helvetica] text-sm font-normal leading-[22.4px] tracking-[0] text-[#3a3447] transition-colors hover:text-[#4a0d8c]"
                      >
                        {item}
                      </button>
                    </li>
              ...
              <nav
                aria-label="Industries and teams"
                className="flex h-fit flex-col items-start gap-4"
              >
                <h3 className="[font-family:'Satoshi-Bold',Helvetica] text-[13px] font-bold leading-[20.8px] tracking-[1.30px] text-[#0f0a1f]">
                  INDUSTRIES &amp; TEAMS
