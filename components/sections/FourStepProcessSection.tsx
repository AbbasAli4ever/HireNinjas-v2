...
const steps = [
  {
    ...
    lines: ["Tell us your hiring or marketing", "goals and the kind of support your", "team actually needs."],
  },
  {
    number: "02",
    ...
    <section className="relative w-full overflow-hidden bg-white py-[70px]">
      <div className="relative z-10 mx-auto flex w-full max-w-[1160px] flex-col items-start gap-[50px] px-4 sm:px-6">
        ...
        <div className="grid w-full grid-cols-1 gap-[14px] sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-[32px]">
          {steps.map((step) => (
            <Card key={step.number} className="min-h-[280px] rounded-[22px] border-0 bg-[#f8f5ff] shadow-none">
