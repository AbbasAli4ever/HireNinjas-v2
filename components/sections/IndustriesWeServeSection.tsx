...
const industryCards = [
  {
    ...
    description: "Multi-currency support for global expansion and multi-user accounts with granular permissions to manage a growing, international team.",
    image: "/figmaAssets/frame-2147224383.png",
    tracking: "tracking-[0]",
  },
  {
    title: "Ecommerce Brands",
    description: "Traditional banks won't touch you. We embrace you. Trade and custody crypto alongside fiat. Instant conversions. Institutional security. Full compliance built-in.",
    image: "/figmaAssets/frame-2147224387.png",
    tracking: "tracking-[0]",
  },
  {
    title: "HealthTech Companies",
    description: "Separate personal and business finances effortlessly. Get paid faster with local account details worldwide. Track expenses automatically for tax time.",
    image: "/figmaAssets/frame-2147224389.png",
    tracking: "tracking-[0]",
  },
  {
    title: "Fintech Platforms",
    description: "Juggling multiple client projects? Create dedicated virtual cards per client. Track spending in real-time. Generate client reports automatically. Close your books faster.",
    image: "/figmaAssets/frame-2147224386.png",
    tracking: "tracking-[0]",
  },
  {
    title: "Enterprise Organizations",
    description: "Sell worldwide without banking headaches. Local account details in major markets, wholesale FX rates, and same-day settlements. Pay suppliers in their currency, get paid in yours.",
      ...
      <div className="mx-auto flex w-full max-w-[1440px] flex-col items-center gap-[50px]">
        <header className="flex w-full max-w-[914px] flex-col items-center gap-6">
          ...
          <p className="self-stretch text-center text-lg font-normal leading-[27.9px] tracking-[0] text-white [font-family:'Inter',Helvetica]">
            HireNinjas understands the challenges associated with scaling rapidly digital businesses,
            <br />
              ...
              >
                <CardContent className="relative h-full p-0">
                  ...
                  <div className="absolute bottom-0 left-0 z-10 flex h-[132px] w-full flex-col justify-end gap-4 bg-[linear-gradient(180deg,rgba(0,0,0,0)_0%,rgba(0,0,0,0.82)_35%,rgba(0,0,0,1)_100%)] px-6 pb-6">
                    ...
                    />
                    <p className={`flex items-center text-sm font-light leading-6 text-white [font-family:'SF_Pro-Light',Helvetica] ${card.tracking}`}>
                      {card.description}
                    </p>
                  </div>
                </CardContent>
