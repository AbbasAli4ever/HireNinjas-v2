    ...
    <section className="w-full">
      <div className="mx-auto w-full max-w-[1200px] px-4 sm:px-6 lg:px-0">
        <Card className="relative overflow-hidden rounded-3xl border border-solid border-[#f0e2ff] bg-[linear-gradient(180deg,rgba(248,241,255,1)_0%,rgba(255,255,255,1)_100%)] shadow-none">
          ...
          />
          <CardContent className="relative flex flex-col items-start gap-[15.4px] p-6 sm:p-10 lg:p-20">
            <Badge
              variant="secondary"
            ...
            <header className="max-w-[998px]">
              <h2 className="[font-family:'Satoshi-Bold',Helvetica] text-[32px] font-bold leading-[1.08] tracking-[-0.92px] text-[#0f0a1f] sm:text-[38px] lg:text-[46px]">
                {sectionContent.title}
              </h2>
            </header>
            <p className="max-w-none self-stretch [font-family:'Montserrat',Helvetica] text-[15px] font-normal leading-[27.2px] tracking-[0] text-[#0f0a1f] sm:text-[16px] lg:text-[17px]">
