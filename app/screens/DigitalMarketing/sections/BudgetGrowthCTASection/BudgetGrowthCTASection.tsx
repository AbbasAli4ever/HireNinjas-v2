      ...
      <Card className="relative w-full overflow-hidden rounded-3xl border-0 bg-transparent shadow-none">
        <CardContent className="relative flex flex-col items-start gap-[15.1px] overflow-hidden rounded-3xl px-6 py-10 sm:px-10 sm:py-14 lg:p-20 [background:linear-gradient(157deg,rgba(89,31,151,1)_0%,rgba(45,2,85,1)_100%)]">
          ...
          <header className="relative flex max-w-[583.74px] flex-col items-start self-start px-0 pb-0 pt-[2.23px]">
            <h2 className="[font-family:'Satoshi-Bold',Helvetica] text-[36px] font-bold leading-[42px] tracking-[-0.92px] text-white sm:text-[40px] sm:leading-[45px] lg:text-[46px] lg:leading-[49.7px]">
              {ctaContent.title[0]}
              <br />
              {ctaContent.title[1]}
            </h2>
          ...
          <div className="relative flex max-w-[697.75px] flex-col items-start">
            <p className="[font-family:'Montserrat',Helvetica] text-[15px] font-normal leading-[24px] tracking-[0] text-[#ffffffd1] sm:text-[16px] sm:leading-[26px] lg:text-[17px] lg:leading-[27.2px]">
              {ctaContent.description[0]}
              <br />
              {ctaContent.description[1]}
            </p>
          </div>
          <nav className="relative flex flex-col items-start gap-4 pt-1 sm:flex-row sm:items-center sm:gap-6">
            <Button
              type="button"
              className="h-auto inline-flex min-h-12 items-center gap-3 rounded-[999px] bg-white py-2 pl-[22px] pr-2 text-[#14101f] hover:bg-white/95"
            >
            ...
            <Button
              type="button"
              variant="outline"
              className="h-auto inline-flex min-h-12 items-center justify-center rounded-[999px] border border-solid border-[#f5efe629] bg-transparent px-[22px] py-3.5 text-[#f5efe6] hover:bg-white/5 hover:text-[#f5efe6]"
            >
