...
export const ExpertRoleHighlightsSection = (): JSX.Element => {
  return (
    <section className="w-full bg-white py-[70px]">
      <div className="mx-auto flex w-full max-w-[1200px] flex-col gap-10 px-6 lg:flex-row lg:items-start lg:gap-8">
        <header className="flex flex-1 flex-col justify-center gap-8">
          ...
          <p className="[font-family:'Montserrat',Helvetica] text-[15px] font-normal leading-[25.6px] tracking-[0] text-[#3a3447]">
