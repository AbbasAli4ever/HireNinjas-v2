    ...
    <section className="relative w-full px-4 py-6 sm:px-6 lg:px-0">
      <div className="mx-auto w-full max-w-[1200px] relative overflow-hidden">
        ...
        <Card className="relative overflow-hidden rounded-3xl border border-[#f0e2ff] bg-[lineargradient(180deg,rgba(248,241,255,1)_0%,rgba(255,255,255,1)_100%)] shadow-none">
          ...
          />
          <CardContent className="relative z-10 flex flex-col items-start gap-[15.4px] p-8 sm:p-10 lg:p-20">
            <Badge
              variant="outline"
              className="inline-flex h-auto items-center gap-2 rounded-[999px] border border-[#f0e2ff] bg-[#f7f1ff] px-3.5
pb-[7.69px] pt-[7.5px] text-[#8a39e4] shadow-none hover:bg-[#f7f1ff]"
            >
              <span className="h-1.5 w-1.5 rounded-[3px] bg-[#8a39e4]" />
              <span
                className="[font-family:'Montserrat',Helvetica] text-xs font-semibold leading-[19.2px] tracking-
[1.68px]"
              >
                {sectionContent.eyebrow}
              </span>
            </Badge>
            <header className="max-w-[998px]">
              <h2
                className="[font-family:'Satoshi-Bold',Helvetica] text-[34px] font-bold leading-[1.08] tracking-[-0.92px]
text-[#0f0a1f] sm:text-[40px] lg:text-[46px]"
              >
            ...
            <p
              className="max-w-none self-stretch [font-family:'Montserrat',Helvetica] text-[15px] font-normal leading-
[27.2px] tracking-[0] text-[#0f0a1f] sm:text-[17px]"
            >
