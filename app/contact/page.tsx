                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <Select onValueChange={field.onChange} value={field.value}>
                            <FormControl>
                              <SelectTrigger className="h-12 rounded-[10px] border-[#ece8f3] bg-[#fafaff] text-[#0f0a1f] focus:border-[#8b3ae5] focus:ring-[#8b3ae5]/20">
            ...
            <aside className="flex w-full flex-col gap-5 lg:w-[340px] lg:shrink-0">
              ...
              <div className="rounded-[18px] border border-[#f1e3ff] bg-gradient-to-b from-[#f8f1ff] to-white p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {["Digital Strategy", "Web & App Dev", "Lead Generation", "SEO & PPC", "Social Media", "Branding", "Video Production", "AI Marketing"].map((tag) => (
